...
class games(models.Model):
	...
	playerScore = models.IntegerField(blank=True)
	opponentScore = models.IntegerField(blank=True)
	playerExchanges = models.IntegerField(blank=True, null=True)
	opponentExchanges = models.IntegerField(blank=True, null=True)
