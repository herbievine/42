...
from games.views import get_games, gamesView
...
urlpatterns = [
    ...
    path('api/games/<str:id>', gamesView, name='preview_game'),
    ...
    path('api/users/<str:username>', usersView, name='manage_user'),
    path('api/users/<str:username>/games', get_games, name='game_history'),
